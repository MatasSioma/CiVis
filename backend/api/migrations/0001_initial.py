# Generated by Django 5.1.15 on 2026-04-08 09:03
...
class Migration(migrations.Migration):
	...
	operations = [
		...
		migrations.AddIndex(
			...
			index=models.Index(
				fields=['job_posting', '-match_score'], name='idx_application_ranking'
			),
		),
		migrations.AddIndex(
			model_name='application',
			index=models.Index(fields=['status'], name='api_applica_status_57b6db_idx'),
		),
		migrations.AddIndex(
			model_name='application',
		...
		migrations.AddIndex(
			model_name='jobposting',
			index=models.Index(fields=['job_type'], name='api_jobpost_job_typ_76b6e7_idx'),
		),
		migrations.AddIndex(
			model_name='jobposting',
			index=models.Index(fields=['status'], name='api_jobpost_status_1732e6_idx'),
		),
		migrations.AddIndex(
			model_name='jobposting',
