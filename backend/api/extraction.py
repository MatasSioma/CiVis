		...
		messages=[
			{
				...
				'content': (
					...
					'containing an array of objects. All output text is in Lithuanian.'
					'Each object must have these fields:\n'
					'- "name": string, the skill name, concise '
					...
					'- "description": string OR null. One short sentence (max ~20 words) '
					'summarizing how this skill appears in the CV — '
					'e.g. the project, tools used, scope, or scale, years of experience. '
					'Return null when the CV provides no detail beyond the skill name.\n\n'
					'Rules:\n'
					...
					'- Descriptions must be grounded in the CV text, not invented\n'
